...
- [common-all.yaml](/common-all.yaml) : This is the top level file for all ESPHome devices which defines global values
- [common-solark.yaml](/common-solark.yaml) : This file breaks down all the values for a single Sol-Ark device
- [solark.yaml](/solark.yaml) : This file pulls in "common-all.yaml" as well as a copy of "common-solark.yaml" for each Sol-Ark inverter.  This sample file demonstrates how to configure 2 inverters.
